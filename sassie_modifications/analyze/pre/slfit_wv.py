...
def slfit(self, app, ratio, T2dia, Htime, freq, TAUc, pdb_filename, out_filename = [], guess = np.array([]), reslist = np.array([]), scaling = 1.0, model = 1, chainID = []):
    mvars = self.mvars
...
#    wtitle = "PRE results ( Model nubmber = " + str(frame + 1) + " )"
    ...
    s1.circle(x='resid', y = 'ratio', size = 8, line_width = 2, color = "red", fill_color = "white",fill_alpha = 0, legend = "Predection", source=source1_predict)
...
#    s1.line(x='resid', y = 'ratio', color = "black", line_width = 2, source=source1_predict)
    ...
    s2 = figure(plot_height=height, plot_width=width, title=s2_title, tools=[hover1,Tools])

    s2.line(x='distance', y = 'ratio', color = "black", line_width = 2, legend = "Experiment", source=source2)
    s2.circle(x='distance', y = 'ratio', size = 8, line_width = 2, color = "red", fill_color = "red", fill_alpha = 0, legend = "Predection", source=source2_predict)
#    s1.asterisk(x='resid', y = 'ratio', size = 10, line_width = 2, color = "black", fill_color = "white",fill_alpha = 0, legend = "Actual fit", source=source1_predict)
#    s1.line(x='resid', y = 'ratio', color = "black", line_width = 2, source=source1_predict)
    ...
    s3_title = "qR-factor = {}; CoorCoeff = {}".format(qR_fact, r)
    ...
    s3.circle(x='experiment', y = 'prediction', size = 8, line_width = 2, color = "red", fill_color = "red", fill_alpha = 0, legend = "Predection", source=source3)
