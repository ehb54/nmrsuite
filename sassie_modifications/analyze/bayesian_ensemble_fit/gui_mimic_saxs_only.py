...
import sassie.analyze.bayesian_ensemble_fit.ensemble_fit as ensemble_fit
...
posterior_burn = '0' #Number of iterations per walker to remove from beginning (lose initial conformation information
